<template>
  <div class="container">
    <h1>Person Form</h1>
      ...
      <b-form-group label-cols="4" label-cols-lg="3" label-size="sm" label="Codigo">
    ...
    create: function (payload) {
      client
        ...
        .then(() => {
          ...
          this.message = "Docente Agragado!";
          this.showMessage = true;
          this.$router.push("/docentes?msg="+this.message);
        })
        .catch((error) => {
          this.message = error;
          this.showMessage = true;
